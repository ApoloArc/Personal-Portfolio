...
function HeroContainer() {
    ...
    return (
        <div className="bg-slate-50 my-2 p-4 md:p-6 w-full md:border md:border-gray-100 md:drop-shadow-lg h-[95vh]  rounded-2xl flex flex-col md:flex-row-reverse justify-around items-center">
            ...
            <motion.div
                ...
                <div>
                    ...
                    <motion.p
                        ...
                        className="text-sm text-gray-500">Hello, I'm Angelo</motion.p>
                    <motion.p
                        // initial={{ opacity: 0, x: "-100vw" }}
                        // animate={{ opacity: 1, x: 0 }}
                        // transition={{ delay: 0.8, type: "spring", bounce: 0.2 }}
                        className="font-bold text-[1.2rem] md:text-[2.5rem] lg:text-[5rem]">I'm a <span className="text-secondary tracking-wide">Full Stack Developer</span>
                    </motion.p>
                </div>
                <div>
                    <motion.p
                    ...
                    <div className="mt-5 flex gap-2">
                        <motion.a
                            ...
                            <FiGithub className="text-xl h-6 p-[3px] cursor-pointer hover:drop-shadow-md" />
                        </motion.a>
                        <motion.a
                            whileHover={{ scale: 1.05 }}
                            // initial={{ opacity: 0, scale: 0.2 }}
                            ...
                            rel="noopener noreferrer">
                            <FiLinkedin className="text-xl h-6 p-[3px] cursor-pointer hover:drop-shadow-md " />
                        </motion.a>
                    </div>
                </div>
            </motion.div>
